...
public class WelcomeView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        closeAppButton.setOpaque(false);
        ...
        getContentPane().add(closeAppButton, new AbsoluteConstraints(520, 380, -1, -1));
        ...
        viewReportsButton.setOpaque(false);
        ...
        getContentPane().add(viewReportsButton, new AbsoluteConstraints(520, 290, -1, -1));

        createReportButton.setBackground(Colors.darkBlue);
        createReportButton.setFont(new Font("Arial", 1, 25)); // NOI18N
        createReportButton.setForeground(Colors.creamWhiteText);
        createReportButton.setText("Crear un reporte");
        createReportButton.setBorder(BorderFactory.createEmptyBorder(2, 100, 2, 14));
        createReportButton.setContentAreaFilled(false);
        createReportButton.setCursor(new Cursor(Cursor.HAND_CURSOR));
        createReportButton.setFocusPainted(false);
        createReportButton.setFocusable(false);
        createReportButton.setHorizontalAlignment(SwingConstants.LEFT);
        createReportButton.setMargin(new Insets(2, 100, 2, 14));
        createReportButton.setMaximumSize(new Dimension(135, 36));
        createReportButton.setMinimumSize(new Dimension(135, 36));
        createReportButton.setOpaque(false);
        createReportButton.setPreferredSize(new Dimension(340, 75));
        createReportButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                createReportButtonActionPerformed(evt);
            }
        });
        getContentPane().add(createReportButton, new AbsoluteConstraints(520, 200, -1, -1));

        createReportLabel.setFont(new Font("Arial", 1, 25)); // NOI18N
        createReportLabel.setForeground(Colors.darkBlue);
        createReportLabel.setPreferredSize(new Dimension(340, 75));
        createReportLabel.setSize(new Dimension(340, 75));
        new SetImageLabel().SetImage(createReportLabel, "/resources/penBar.png");
        getContentPane().add(createReportLabel, new AbsoluteConstraints(520, 200, -1, -1));
        ...
        getContentPane().add(viewReportsLabel, new AbsoluteConstraints(520, 290, -1, -1));
        ...
        getContentPane().add(closeAppLabel, new AbsoluteConstraints(520, 380, -1, -1));
    ...
    public JLabel createReportLabel;
