...
public class DetailedReportView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        answerReference.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        answerReference.setForeground(Colors.darkBlue);
        answerReference.setText("Por:");
        answerReference.setPreferredSize(new java.awt.Dimension(500, 23));
        getContentPane().add(answerReference, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 420, 30, -1));

        dateInfo2.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        dateInfo2.setForeground(Colors.darkBlue);
        dateInfo2.setText("DATE_INFO");
        dateInfo2.setPreferredSize(new java.awt.Dimension(500, 23));
        getContentPane().add(dateInfo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 440, 210, -1));

        answerInfo.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        answerInfo.setForeground(Colors.darkBlue);
        answerInfo.setText("REPORTER_INFO");
        ...
        uploadReportButton.setText("ELIMINAR REPORTE");
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 200, 220, 210));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 310, 580, -1));
